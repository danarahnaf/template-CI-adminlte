          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row"> 
                  <div class="col-sm-4">
                    <form method="POST" action="<?php echo base_url().'potongan/tampil' ?>">
                      <select class="form-select form-select-lg mb-3" id="divisi"  aria-label=".form-select-lg example" name="divisip">
                  ...
                  <div class="col-sm-4">
                    <select class="form-select form-select-lg mb-3" id="departmentp" name="departp">                         
                   </select>
                  </div>
                   <div class="col-sm-4">
                     <button class="btn btn-primary" id="tampilp" onclick="tampil()">submit</button>  
                   </div>
